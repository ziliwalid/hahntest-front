    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className={`fixed inset-y-0 left-0 z-50 w-64 bg-white shadow-lg transform ${
        ...
        <div className="px-4 py-3 border-t border-gray-200">
          <div className="text-xs font-medium text-gray-500 mb-2">API Status</div>
          <HealthCheck compact={true} interval={60000} />
        </div>
      ...
      {/* Floating Health Check (only on desktop when not in sidebar) */}
      <div className="hidden lg:block">
        <HealthCheck interval={30000} showDetails={true} />
      </div>
    </div>
  );
};
